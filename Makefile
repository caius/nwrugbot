...
COMPONENTS = nwrugbot signalstatus githubstatus github.com/caius/gobot github.com/thoj/go-ircevent github.com/jessevdk/go-flags
...
install: | submodules
	GOPATH=$(THIS_DIR) go install $(BUILD_OPTIONS) nwrugbot
